    ...
    return (
        <div className="px-0 py-0">
            ...
            <div className="relative w-full h-[60vh] sm:h-[70vh] md:h-[80vh] lg:h-[90vh]">
                ...
                <div className="absolute inset-0  bg-opacity-50 flex items-center justify-start px-4 sm:px-8 md:px-16 lg:px-24 z-10">
                    <div className="text-blue-900 font-semibold max-w-2xl space-y-4">
                        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">
                            About Agarwal's Dental Clinic
                        </h1>
                        <p className="text-sm sm:text-base md:text-lg  font-semibold lg:text-xl">
                        ...
                        <p className="hidden sm:block text-sm sm:text-lg md:text-base">
